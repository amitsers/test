      ...
      <div class="col-sm-10 col-sm-offset-2 col-xs-10">
        ...
        <div class="row wowload fadeIn">
          <div class="form-group">
            ...
            <input type="text" class="profile-text disabled-name uline-text-box" onclick="editProfile('name')" id="disabled-name" value="Sahil Som">
            <span class="glyphicon glyphicon-pencil send-profile edit-name" title="Edit" onclick="editProfile('name')"></span>
            <input type="text" class="profile-text enable-name" id="enable-name" >            
            <span class="glyphicon glyphicon-ok send-profile update-name" title="Save" onclick="updateProfile('name')"></span>
          </div>

          <div class="form-group">
            <label for="email" class="control-label">Email: </label><br/>
            <input type="text" class="profile-text disabled-email uline-text-box" title="Edit" onclick="editProfile('email')" id="disabled-email" value="amit@gmail.com">
            <span class="glyphicon glyphicon-pencil send-profile edit-email" onclick="editProfile('email')"></span>
            <input type="text" class="profile-text enable-email" id="enable-email" >            
            <span class="glyphicon glyphicon-ok send-profile update-email" title="Save" onclick="updateProfile('email')"></span>
          </div>

          <div class="form-group">
            <label for="mobile" class="control-label">Mobile: </label><br/>
            <input type="text" class="profile-text disabled-mobile uline-text-box" title="Edit" onclick="editProfile('mobile')" id="disabled-mobile" value="">
            <span class="glyphicon glyphicon-pencil send-profile edit-mobile" onclick="editProfile('mobile')"></span>
            <input type="text" class="profile-text enable-mobile" id="enable-mobile" >            
            <span class="glyphicon glyphicon-ok send-profile update-mobile" title="Save" onclick="updateProfile('mobile')"></span>
          </div>

          <div class="form-group">
            <label for="street" class="control-label">Lane/Street: </label><br/>
            <input type="text" class="profile-text disabled-street uline-text-box" title="Edit" onclick="editProfile('street')" id="disabled-street" value="">
            <span class="glyphicon glyphicon-pencil send-profile edit-street" onclick="editProfile('street')"></span>
            <input type="text" class="profile-text enable-street" id="enable-street" >            
            <span class="glyphicon glyphicon-ok send-profile update-street" title="Save" onclick="updateProfile('street')"></span>
          </div>

          <div class="form-group">
            <label for="address" class="control-label">Address: </label><br/>
            <input type="text" class="profile-text disabled-address uline-text-box" title="Edit" onclick="editProfile('address')" id="disabled-address" value="">
            <span class="glyphicon glyphicon-pencil send-profile edit-address" onclick="editProfile('address')"></span>
            <input type="text" class="profile-text enable-address" id="enable-address" >            
            <span class="glyphicon glyphicon-ok send-profile update-address" title="Save" onclick="updateProfile('address')"></span>
          </div>

          <div class="form-group">
            <label for="state" class="control-label">State: </label><br/>
            <input type="text" class="profile-text disabled-state uline-text-box" title="Edit" onclick="editProfile('state')" id="disabled-state" value="">
            <span class="glyphicon glyphicon-pencil send-profile edit-state" onclick="editProfile('state')"></span>
            <input type="text" class="profile-text enable-state" id="enable-state" >            
            <span class="glyphicon glyphicon-ok send-profile update-state" title="Save" onclick="updateProfile('state')"></span>
          </div>

          <div class="form-group">
            <label for="pincode" class="control-label">Pincode: </label><br/>
            <input type="text" class="profile-text disabled-pincode uline-text-box" title="Edit" onclick="editProfile('pincode')" id="disabled-pincode" value="">
            <span class="glyphicon glyphicon-pencil send-profile edit-pincode" onclick="editProfile('pincode')"></span>
            <input type="text" class="profile-text enable-pincode" id="enable-pincode" >            
            <span class="glyphicon glyphicon-ok send-profile update-pincode" title="Save" onclick="updateProfile('pincode')"></span>
          </div>

          <div class="form-group">
            <label for="country" class="control-label">Country: </label><br/>
            <input type="text" class="profile-text disabled-country uline-text-box" title="Edit" onclick="editProfile('country')" id="disabled-country" value="">
            <span class="glyphicon glyphicon-pencil send-profile edit-country" onclick="editProfile('country')"></span>
            <input type="text" class="profile-text enable-country" id="enable-country" >            
            <span class="glyphicon glyphicon-ok send-profile update-country" title="Save" onclick="updateProfile('country')"></span>
          </div>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var fields = ['name', 'email', 'mobile', 'street', 'address', 'state', 'pincode', 'country'];
    for(var a = 0; a < fields.length; a++) {
      ...
      $(".update-"+fields[a]).hide();
        ...
        $(".enable-"+fields[a]).bind("enterKey",function(e){
          ...
          updateProfile(field[1]);     
          var nextFieldIndex = fields.indexOf(field[1]) + 1;
          if (nextFieldIndex <= fields.length) {
            editProfile(fields[nextFieldIndex]);
          }
        });
