      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a href="./" class="navbar-brand">
            <img class="noo-logo-img noo-logo-normal other-audition-logo" src="images/online-auditoin-logo.png" alt="The Viral Voice Logo"/>
            <img class="noo-logo-img noo-logo-floating other-audition-logo" src="images/online-auditoin-logo.png" alt="The Viral Voice Logo"/>
          </a>
        </div>  
